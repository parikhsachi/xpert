...
const Home = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="w-full flex-grow flex flex-col justify-center items-center text-center p-8">
      ...
      <footer className="bg-gray-50 border-t border-gray-200 mt-12 text-sm text-gray-600">
        <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-6">
          
          {/* Branding */}
          <div>
            <h3 className="text-nu-purple font-semibold text-lg mb-2">Xpert.ai</h3>
            <p>
              Connecting you with credible experts, backed by research. Built at Northwestern.
            </p>
          </div>

          {/* Navigation Links */}
          <div>
            <h4 className="text-gray-800 font-semibold mb-2">Links</h4>
            <ul className="space-y-1">
              <li><a href="/" className="hover:text-nu-purple transition">Home</a></li>
              <li>
                <a
                  href="https://github.com/parikhsachi/xpert"
                  className="hover:text-nu-purple transition"
                  target="_blank"
                  rel="noreferrer"
                >
                  GitHub
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li>
                <a href="mailto:sachiparikh2025@u.northwestern.edu" className="text-blue-600 hover:underline">
                  sachiparikh2025@u.northwestern.edu
                </a>
              </li>
              <li>
                <a href="mailto:ianslater2026@u.northwestern.edu" className="text-blue-600 hover:underline">
                  ianslater2026@u.northwestern.edu
                </a>
              </li>
              <li>
                <a href="mailto:rahibtaher2026@u.northwestern.edu" className="text-blue-600 hover:underline">
                  rahibtaher2026@u.northwestern.edu
                </a>
              </li>
            </ul>
            <p className="mt-2">Northwestern University</p>
            <p>Evanston, IL</p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 text-center py-4 text-xs text-gray-500">
          &copy; {new Date().getFullYear()} Xpert.ai. All rights reserved.
        </div>
      </footer>
    </div>
  );
